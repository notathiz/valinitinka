...
document.getElementById('yessir').addEventListener('click', () => {
    alert('Поздравляю вас! Вы были приглашены на ужин Дня Святого Валентина. Будем ожидать вас 15 февраля в 15:30 в Pasta la Vista по адресу Богенбай батыра 104!')
})
